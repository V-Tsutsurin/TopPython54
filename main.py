...
# # #
# # # out = MyOuter("Внешний")
# # # # out.outer_class_method()
# # # inner = out.MuInner("Внутренний", out)
# # # inner.inner_method()
# #
# #
# # # class Color:
...
# # #         def display2(self):
# # #             print("Вложенный в дочерний класс")
# # #
# # # a = Sub_Class()
# # # a.display()
# # #
...
# # #
# # # class Teacher(Human):
# # #     def __init__(self, lastname, name, age, specialization, experience):
# # #         super().__init__(lastname, name, age)
...
# # #     def info(self):
# # #         super().info()
# # #         print(f"{self.specialization}, {self.experience}", end="" )
# # #
# # #
...
# # # print(f'Серриализация в строку\n{d_save}')
# # # print('*' * 30)
# # # d_read = pickle.loads(d_save)
# # # print(f'Десерриализация в строку\n{d_read}')
# #
# #
# # # class Test2:
# # #     def __init__(self):
...
# #
# # data = {
# #     "first_name": "Ivan", #adsdad
# #     "last_name": "Petrov",
# #     "hobbies": ('runnig', 'diving', 'singing'),
# #     "age": 999,
# #     "children": [
# #         {
# #             "name": "Ivpatiy",
...
# #
# #
# # st1 = Student('Petrov', [5, 1, 4, 3, 4, 5, 2])
# # st2 = Student('Ivanov', [3, 4, 2, 5, 3, 2, 3])
# # st3 = Student('Kosheva', [5, 4, 5, 4, 2, 5, 4, 5])
# # st4 = Student('Ignatova', [2, 3, 4, 5, 5, 4, 3, 2])
# # sts = [st1, st2]
# #
...
#
#
#     # for it ,gr in session.query(Lesson.lesson_title, Group.group_name).filter(and_(Group.group_name == "RPO-9",Group.id == association_table.c.group_id, association_table.c.lesson_id == Lesson.id)):
#     #     print(it, gr)
#     # print('*' * 100)
#
...
# age = 28
#
# # tm = Template("Меня зовут {{ name }}. Мне {{ a }} лет.")
# tm = Template("Мне {{ a*2 }} лет. Меня зовут {{ name.upper() }}.")
#
# msg = tm.render(name=name, a=age)
# print(msg)

# per = {'name': 'Иван', 'age': 30}
#
...
# link = """В HTML-документе ссылка орпеделяется так
# <a href="#">Ссылка</a>"""
#
# tm = Template("{{ link | e }}")
...
#     {'id':2, 'city': 'СПБ'},
#     {'id':3, 'city': 'Казань'},
#     {'id':4, 'city': 'Яролославль'},
#     {'id':5, 'city': 'Воронеж'},
#     {'id':6, 'city': 'Архангельск'},
# ]
#
...
#     {'model': 'Scoda', 'price': 17900},
#     {'model': 'Wolksvagen', 'price': 44000},
#     {'model': 'BMW', 'price': 84000},
# ]
...
# tpl = "Автомобиль: {{ cs | replace('model', 'Бренд') }}"
